package com.application.mindart.app.handler;
...
import com.application.mindart.app.api.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> handUserValidation(Exception ex) {
        return new ResponseEntity<>(new ApiError(ex.getMessage(), "UNEXPECTED_ERROR"), HttpStatus.BAD_REQUEST);
    }
